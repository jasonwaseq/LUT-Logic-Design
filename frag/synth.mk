...
ice40.json: top.sv filelist.json $(SYNTH_SOURCES)
	$(YOSYS) -ql ice40.yslog -p 'synth_ice40 -top top -json $@' top.sv $(SYNTH_SOURCES) $(DEFINES)
...
mapped.json: filelist.json $(SYNTH_SOURCES)
	$(YOSYS) -ql mapped.yslog -p 'synth_ice40 -top $(ABSTRACT_TOP) -json $@' $(SYNTH_SOURCES) $(DEFINES)
...
abstract.json: filelist.json $(SYNTH_SOURCES)
	$(YOSYS) -ql abstract.yslog -p 'prep -top $(ABSTRACT_TOP) -flatten; json -o $@' $(SYNTH_SOURCES) $(DEFINES)
